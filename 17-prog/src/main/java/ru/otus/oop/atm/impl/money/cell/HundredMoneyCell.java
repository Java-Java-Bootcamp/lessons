...
public class HundredMoneyCell extends AbstractMoneyCell {
    ...
    @JsonCreator
    public HundredMoneyCell(@JsonProperty("maxNumber") int maxNumber) {
        super(maxNumber);
    }
    ...
    public MoneyCell deserializeFromJson() {
        try {
            ...
            HundredMoneyCell cell = mapper.readValue(new File(fileName()), this.getClass());
            return cell;
