...
public class FiftyMoneyCell extends AbstractMoneyCell {
    ...
    @JsonCreator
    public FiftyMoneyCell(@JsonProperty("maxNumber") int maxNumber) {
        super(maxNumber);
    }

    @Override
    protected String fileName() {
        return "FiftyMoneyCell.txt";
    }
    ...
    public MoneyCell deserializeFromJson() {
        try {
            ...
            FiftyMoneyCell cell = mapper.readValue(new File(fileName()), this.getClass());
            return cell;
