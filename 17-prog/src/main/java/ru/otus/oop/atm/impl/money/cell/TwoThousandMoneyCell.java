...
public class TwoThousandMoneyCell extends AbstractMoneyCell {
    private final Denomination denomination = Denomination.TWO_THOUSAND;

    @JsonCreator
    public TwoThousandMoneyCell(@JsonProperty("maxNumber") int maxNumber) {
        super(maxNumber);
    }
    ...
    protected String fileName() {
        return "TwoThousandMoneyCell.txt";
    }
    ...
    public MoneyCell deserializeFromJson() {
        try {
            ...
            TwoThousandMoneyCell cell = mapper.readValue(new File(fileName()), this.getClass());
            return cell;
