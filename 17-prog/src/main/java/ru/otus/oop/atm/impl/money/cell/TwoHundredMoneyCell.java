...
public class TwoHundredMoneyCell extends AbstractMoneyCell {
    ...
    @JsonCreator
    public TwoHundredMoneyCell(@JsonProperty("maxNumber") int maxNumber) {
        super(maxNumber);
    }
    ...
    protected String fileName() {
        return "TwoHundredMoneyCell.txt";
    }
    ...
    public MoneyCell deserializeFromJson() {
        try {
            ...
            TwoHundredMoneyCell cell = mapper.readValue(new File(fileName()), this.getClass());
            return cell;
